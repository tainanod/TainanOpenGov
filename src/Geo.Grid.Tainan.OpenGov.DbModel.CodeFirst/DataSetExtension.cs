...
namespace Geo.Grid.Tainan.OpenGov.DbModel.CodeFirst
{
    ...
    [Table("DataSetExtension", Schema = "dbo")]
    [System.CodeDom.Compiler.GeneratedCode("EF.Reverse.POCO.Generator", "2.34.1.0")]
    public class DataSetExtension
    {
        [DatabaseGenerated(DatabaseGeneratedOption.None)]
        [Column(@"ExtensionId", Order = 1, TypeName = "uniqueidentifier")]
        [Index(@"PK_dbo.DataSetExtension", 1, IsUnique = true, IsClustered = true)]
        [Required]
        [Key]
        ...
        public DataSetExtension()
        {
            ExtensionId = System.Guid.NewGuid();
            Title = "";
            Sort = 0;
            IsEnabled = true;
