(function () {
    ...
    function discussController($scope, $sce, $timeout, discussService) {
        ...
        $scope.GetDiscuss = function (forumId, currentPage, pageSize) {            
            ...
            var param = { 'ParticipationId': forumId, 'KeyWord': $scope.getKeyWord, 'TagId': $scope.getTag, 'SortId': $scope.getSort, "CurrentPage": currentPage };
        ...
        $scope.replySubmit = function (upperDiscuss) {
            ...
            var data = { ParticipationId: $scope.forumId, UserId: $scope.user.Id, Message: message, UpperId: upperDiscuss.DiscussId };
        ...
        $scope.discussSubmit = function () {
            ...
            var data = { ParticipationId: $scope.forumId, UserId: $scope.user.Id, Message: $scope.vm.DiscussTextArea, TagIds: tagIds };
            discussService.sendReply(data).success(function (ret) {
                if (ret.Success) {
