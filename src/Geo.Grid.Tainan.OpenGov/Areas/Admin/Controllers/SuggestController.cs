...
namespace Geo.Grid.Tainan.OpenGov.Areas.Admin.Controllers
{
    ...
    public class SuggestController : Controller
    {
        ...
        public SuggestController(IForumService service, IPhotoService photoService,
        ...
        public ActionResult PartialList(int page = 1)
        {
            ...
            IQueryable<Forum> forums = service.QueryForum(ForumType.市政提案).OrderByDescending(x => x.OpenDate);
        ...
        public ActionResult Create(Forum model)
        {
            ...
            model.ForumType = ForumType.市政提案;
